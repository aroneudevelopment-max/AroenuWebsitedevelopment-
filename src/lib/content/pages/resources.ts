...
export const resourcesPage: PageContent = {
  ...
  seo: {
    metaTitle: "Resources — practical briefs on governable capability | Aroneu",
    metaDescription:
      "Practical resources on governable India capability teams, visibility, continuity, and AI-supported governance. None of the content is fabricated.",
  },
  sections: [
    {
      id: "hero",
    ...
    },
    {
      ...
      body: "Aroneu is preparing practical resources on governable India capability, AI-supported governance, and operating rhythm. New resources will appear here once they are approved.",
    ...
    },
    {
      ...
      body: "If you are working through a particular governance or capability question, contact Aroneu. We can help shape the right brief for your team.",
      primaryCTA: { label: "Book a call", href: "/contact" },
