...
export default function TermsPage() {
  return (
    ...
    >
      <section>
        <p>
          These Website Terms of Use explain how you may use the public Aroneu
          website.
        </p>
        <p>
          They apply only to this website and its public content. They do not
          replace any separate client agreement, master services agreement, data
          processing agreement, employment agreement, AI Workspace agreement, or
          other written contract with Aroneu.
        </p>
        <p>
          By using this website, you agree to use it lawfully and in line with
          these terms.
        </p>
      </section>
