...
export function AboutHero({ data }: { data?: SectionContent }) {
  if (!data) return null;
  return (
    <section className="section-aroneu pt-32 pb-24 relative overflow-hidden">
      <div className="container-aroneu grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="relative z-10 w-full aspect-[4/3] bg-zinc-50 dark:bg-zinc-900 rounded-3xl overflow-hidden border border-zinc-200 dark:border-zinc-800">
          {data.image && (
            <Image 
              src={data.image} 
