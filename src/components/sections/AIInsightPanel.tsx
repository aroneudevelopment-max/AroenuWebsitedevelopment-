...
export function AIInsightPanel({ data }: { data?: SectionContent }) {
 ...
 <div className="w-full h-[400px] flex items-center justify-center opacity-60">Representative AI Insight</div>
 )}
 ...
 <span key={i} className="font-mono text-xs px-3 py-1.5 bg-zinc-100 opacity-80 rounded border border-zinc-200">
 {item.title}
 </span>
 ))}
 </div>
