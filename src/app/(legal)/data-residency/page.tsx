...
export default function DataResidencyPage() {
  return (
    <LegalShell
      eyebrow="Legal"
      heading="Data and Access Note"
      updatedNote="Last updated: 7 July 2026"
      intro="This note explains how Aroneu describes data residency, data access, AI Workspace visuals, and cross-border operating controls on this website."
      path="/data-residency"
    >
      <section>
        <p>
          This note is written for clients, procurement teams, legal reviewers,
          data protection teams, and security stakeholders who want to
          understand the boundary between Aroneu&apos;s public website, the AI
          Workspace, and client-specific engagements.
        </p>
        <p>
          It does not replace any client agreement, data processing agreement,
          security schedule, technical architecture document, or
