...
export const insightsIndexContent: PageContent = {
  ...
  slug: "insights",
  pageJob:
    "Show intellectual authority by answering serious buyer questions about governance, visibility, capability teams, continuity, and distributed-team trust.",
  seo: {
    metaTitle: "Insights - the brief | Aroneu",
    metaDescription:
      "Practical thinking on governable India capability teams, visibility, continuity, AI Workspace governance, and distributed-team trust.",
    ogTitle: "The brief on governable capability.",
    ogDescription:
      "Aroneu insights answer serious buyer questions about India capability, visibility, governance, and long-term continuity.",
  },
  sections: [
    {
      id: "hero",
      ...
      body:
        "Clear thinking for leaders building India capability without losing visibility, accountability, or control.",
      image: "/images/aroneu/ai-workspace-visibility-by-default.jpeg",
      imageAlt: "",
      ctas: [
        {
          label: "Read featured insight",
    ...
    },
    {
      ...
      type: "answer",
      body:
        "Aroneu insights explain how European companies can make India capability more governable through team design, operating rhythm, visibility, documentation, controls, and AI-supported governance.",
    },
    {
      id: "featured-article",
      ...
      faqs: [
        {
          ...
          answer:
            "Aroneu writes about governable India capability, team design, visibility, continuity, AI-supported governance, and distributed-team trust.",
        },
        {
          question: "Are these generic blog posts?",
          answer:
            "No. Each insight should answer one serious buyer question clearly. The goal is to help leaders understand the operating model before they make a team decision.",
        },
        {
          question: "Can insights help us compare team models?",
          answer:
            "Yes. Some insights compare models such as a Capability Team, staffing model, EOR model, captive centre, or traditional vendor delivery.",
        },
        {
          question: "Can we suggest a topic?",
          answer:
            "Yes. If you are trying to understand a governance problem, contact Aroneu and share the question you are working through.",
        },
      ],
    },
  ],
