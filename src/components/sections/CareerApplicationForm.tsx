      ...
      <div className="space-y-6">
        <div>
          ...
          <input
            ...
            className="mt-2 block w-full rounded-lg border border-aroneu-neutral-300 bg-white px-4 py-3 text-body transition-colors focus:border-aroneu-neutral-900 focus:outline-none focus:ring-1 focus:ring-aroneu-neutral-900"
          />
        ...
        <div>
          ...
          <div className="mt-2 flex items-center justify-center w-full">
            <label htmlFor="cv" className="flex flex-col items-center justify-center w-full h-32 border-2 border-aroneu-neutral-300 border-dashed rounded-lg cursor-pointer bg-white hover:bg-aroneu-neutral-50 focus-within:ring-2 focus-within:ring-aroneu-neutral-900 transition-colors">
