      ...
      <section className="py-16">
        <div className="container-aroneu max-w-3xl mx-auto">
          <div className=" space-y-6">
            ...
            <h2 className="text-h2 mt-16 mb-6  text-ink">1. Who is responsible for your data</h2>
            ...
            <h2 className="text-h2 mt-16 mb-6  text-ink">2. What this policy covers</h2>
            ...
            <h2 className="text-h2 mt-16 mb-6  text-ink">3. Data we process when you visit the website</h2>
            ...
            <p className="text-body"><strong>Hosting provider:</strong><br /></p>
            <p className="text-body"><strong>Retention:</strong><br /></p>

            <h2 className="text-h2 mt-16 mb-6  text-ink">4. Data we process when you contact us</h2>
            ...
            <h2 className="text-h2 mt-16 mb-6  text-ink">5. Data we process when you book a call</h2>
            ...
            <p className="text-body"><strong>Scheduling provider:</strong><br /></p>
            ...
            <h2 className="text-h2 mt-16 mb-6  text-ink">6. Data we process when you subscribe to updates</h2>
            ...
            <p className="text-body"><strong>Newsletter provider:</strong><br /></p>
            ...
            <h2 className="text-h2 mt-16 mb-6  text-ink">7. Data we process when you download resources</h2>
            ...
            <h2 className="text-h2 mt-16 mb-6  text-ink">8. Data we process when you apply for a role</h2>
            ...
            <h2 className="text-h2 mt-16 mb-6  text-ink">9. Cookies and similar technologies</h2>
            ...
            <p className="text-body">You can change or withdraw your cookie preferences at any time through .</p>
            <p className="text-body"><strong>Consent management provider:</strong><br /></p>

            <h2 className="text-h2 mt-16 mb-6  text-ink">10. Analytics</h2>
            ...
            <p className="text-body"><strong>Analytics provider:</strong><br /></p>
            ...
            <h2 className="text-h2 mt-16 mb-6  text-ink">11. Security and spam prevention</h2>
            ...
            <p className="text-body"><strong>Security provider:</strong><br /></p>
            ...
            <h2 className="text-h2 mt-16 mb-6  text-ink">12. CRM and business communication</h2>
            ...
            <p className="text-body"><strong>CRM provider:</strong><br /></p>
            ...
            <h2 className="text-h2 mt-16 mb-6  text-ink">13. Processors and service providers</h2>
            ...
            <p className="text-body"><strong>Current provider list:</strong><br /></p>
            ...
            <h2 className="text-h2 mt-16 mb-6  text-ink">14. International data transfers</h2>
            ...
            <h2 className="text-h2 mt-16 mb-6  text-ink">15. AI Workspace and client data</h2>
            ...
            <h2 className="text-h2 mt-16 mb-6  text-ink">16. Data we receive from others</h2>
            ...
            <h2 className="text-h2 mt-16 mb-6  text-ink">17. How long we keep personal data</h2>
            ...
            <h2 className="text-h2 mt-16 mb-6  text-ink">18. Your rights</h2>
            ...
            <h2 className="text-h2 mt-16 mb-6  text-ink">19. Right to object</h2>
            ...
            <h2 className="text-h2 mt-16 mb-6  text-ink">20. Security</h2>
            ...
            <h2 className="text-h2 mt-16 mb-6  text-ink">21. External links</h2>
            ...
            <h2 className="text-h2 mt-16 mb-6  text-ink">22. Children</h2>
            ...
            <h2 className="text-h2 mt-16 mb-6  text-ink">23. Changes to this Privacy Policy</h2>
            ...
            <h2 className="text-h2 mt-16 mb-6  text-ink">24. Contact</h2>
