...
export function CaseStudyGrid({ data, caseStudies, emptyState }: { data: any, caseStudies: CaseStudy[], emptyState?: any }) {
 ...
 <h3 className="text-xl font-medium tracking-tight mb-3 group-hover:text-zinc-700 :text-zinc-300 transition-colors">
 {caseStudy.title}
 </h3>
 ...
 <div className="py-4 border-t border-zinc-100 mb-6">
 <p className="text-sm font-medium">Proof point:</p>
 <p className="text-sm text-zinc-600">{caseStudy.proofPoint}</p>
 </div>
