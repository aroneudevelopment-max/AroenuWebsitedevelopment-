...
export function WorkspaceVisibilityPanel({ data }: { data?: SectionContent }) {
 ...
 <div className="flex justify-center relative w-full rounded-2xl overflow-hidden border border-zinc-200 surface-sand shadow-sm transition-opacity duration-500">
 {panelData.image ? (
