...
export function CareerRoleCard({ role }: { role: CareerRole }) {
  return (
    <Link 
      ...
      className="group block rounded-2xl border border-aroneu-neutral-200 bg-white p-6 transition-all duration-200 hover:-translate-y-px hover:border-aroneu-neutral-300 hover:shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-aroneu-neutral-900"
    >
