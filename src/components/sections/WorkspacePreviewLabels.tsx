...
export function WorkspacePreviewLabels({ data }: { data?: SectionContent }) {
 ...
 <div className="container-aroneu max-w-5xl mx-auto">
  <div className="relative w-full rounded-2xl overflow-hidden border border-zinc-200 shadow-2xl transition-transform duration-700 hover:rotate-0" style={{ transform: "perspective(1200px) rotateY(-4deg) rotateX(2deg)" }}>
  {panelData.image ? (
