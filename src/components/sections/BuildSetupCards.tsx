...
export function BuildSetupCards({ data }: { data?: SectionContent }) {
  ...
  return (
    <section className="section-aroneu py-24 bg-white dark:bg-black border-b border-zinc-200 dark:border-zinc-800">
      <div className="container-aroneu max-w-5xl mx-auto flex flex-col md:flex-row-reverse gap-12">
        ...
        <div className="flex-1 grid grid-cols-1 sm:grid-cols-2 gap-4">
          {typedData.features && typedData.features.map((feature: any, idx: number) => (
            <div key={idx} className="p-6 bg-zinc-50 dark:bg-zinc-900 rounded-xl border border-zinc-200 dark:border-zinc-800 shadow-sm transition-all hover:shadow-md">
